...
if __name__ == "__main__":
    ...
    query = queryStatement( # TODO: Fill this in
        theSelect = "Owner.Name, Animal.Name",
        theFrom = "Owner, Animal",
        theWhere = "Animal.Type == 'Cat' and Animal.ID == Owner.AnimalID",
    )
    ...
    query = queryStatement( # TODO: Fill this in
        theSelect = "Owner.Name, Animal.Name",
        theFrom = "Owner, Animal",
        theWhere = "Animal.Age <= 3 and Animal.ID == Owner.AnimalID",
    )
    for x in theCursor.execute(query):
        print(x)
    ...
    query = queryStatement( # TODO: Fill this in
        theSelect = "COUNT(DISTINCT(Vet.VetID))",
        theFrom = "Vet, Owner as o1, Owner as o2",
        theWhere = "Vet.VetID == o1.VetID and Vet.VetID == o2.VetID and o1.Name != o2.Name",
    )
    for x in theCursor.execute(query):
        print(x)
